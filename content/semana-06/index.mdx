...
¿No lograste completar la semana o quieres comparar tu código con la solución? Descarga el estado del proyecto al terminar la Semana 6:

**[⬇️ Descargar entregable Semana 6 (.zip)](https://github.com/abecerraguz/blog-cms/archive/refs/tags/semana-05.zip)**

**Qué incluye:** proyecto monorepo completo con frontend conectado al servidor Express: `articulosService.ts`, React Router v6 con todas las rutas (públicas, detalle, admin protegido), `ProtectedRoute`, páginas `HomePage`, `DetallePage`, `AdminLogin`, `AdminListado`.
...
npm run dev    # frontend (5173) + backend Express con mock (3001)
```
