...
¿No lograste completar la semana o quieres comparar tu código con la solución? Descarga el estado del proyecto al terminar la Semana 4:

**[⬇️ Descargar entregable Semana 4 (.zip)](https://github.com/abecerraguz/blog-cms/archive/refs/tags/semana-06.zip)**

**Qué incluye:** proyecto completo con `TemaContext`, `AuthContext`, `useFormularioArticulo`, todos los componentes y los tipos de semanas anteriores. Es un único proyecto Vite — la estructura monorepo llega en la Semana 5.

> **Nota:** El entregable disponible incluye el avance acumulado hasta la Semana 6. Enfoca tu revisión en los archivos de `src/context/`.
